...
public class Worker : IHostedService
{
	...
	private async Task<bool> TryToMigrate(ApplicationDbContext dbcontext, ILogger<Worker> logger)
	{
		try
		{
	...
	private async Task SeedDefaultData(ApplicationDbContext dbcontext, ILogger<Worker> logger)
	{
		try
		{
	...
	private async Task SeedDefaultUsersAndRoles(UserManager<ApplicationUser> usermanager, RoleManager<ApplicationRole> rolemanager, ILogger<Worker> logger)
	{
		...
		{
			var adminRole = "Admin";
			var adminUser = new TempUser(name: "administrador", email: "usuario.administrador@gmail.com", password: "Pa55w.rd", nombre: "Usuario", apellido: "Administrador", roles: new List<string>() { adminRole });

			var gerenteRole = "Gerente";
			var gerenteUser = new TempUser(name: "gerente", email: "usuario.gerente@gmail.com", password: "Pa55w.rd", nombre: "Usuario", apellido: "Gerente", roles: new List<string>() { gerenteRole });

			var intendenteRole = "Intendente";
			var intendenteUser = new TempUser(name: "intendente", email: "usuario.intendente@gmail.com", password: "Pa55w.rd", nombre: "Usuario", apellido: "Itendente", roles: new List<string>() { intendenteRole });
